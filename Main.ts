...
const flightRoute2=new FlightRoute("002");
flightRoute2.addDepartureDate(date1)
flight2.addFlightRoute(flightRoute2)
...
const pilot1=new Pilot('Hak', 'Chunn', 170, 34, Gender.Male, 700000, 100);
pilot1.addFlight(flight1);
// pilot1.addFlight(flight2);
pilot1.addFlight(flight3);
// pilot1.GetFlight(date1);
console.log(pilot1.GetFlight(date1));
